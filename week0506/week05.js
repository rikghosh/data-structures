...
var content = fs.readFileSync('aapages/m10.txt');
...
for (var i in meetingNames) {
    ...
    meetingNames[18] = 'WASHINGTON HEIGHTS (:I)';
    meetingNames[19] = 'WASHINGTON HEIGHTS (:II)';
    meetingNames[21] = 'WOMEN\'S NITE';
};
...
async.eachSeries(combinedData, function(value, callback) {
    ...
    fs.writeFileSync('meetingsData.txt', JSON.stringify(combinedData));
